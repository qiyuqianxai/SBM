...
class Double_DQN():
    ...
    def learn(self):
        ...
        batch_memory = torch.tensor(batch_memory,dtype=torch.float).to(self.args.device)
        self.eval_net.eval()
...
def get_args():
    ...
    parser.add_argument('--train_data_pth', type=str, default='MNIST/train',
                        help='train_data_pth')
    parser.add_argument('--test_data_pth', type=str, default='MNIST/test',
                        help='test_data_pth')
    ...
    parser.add_argument('--node_epochs', type=int, default=2,

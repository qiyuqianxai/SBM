...
plt.bar(["EA","BDDS","FL"], total_e, color='rbgy')  # or `color=['r', 'g', 'b']`
# plt.legend(loc='best')
plt.ylabel('energy_value')
plt.xlabel('methods')
# plt.grid()
plt.savefig("FL_BDDS_ra_ea_e.png")

plt.figure()
plt.plot(np.array(result_ea_loss), c='r', label='loss of DCFL+EA')
plt.plot(np.array(result_rl_loss), c='b', label='loss of DCFL+BDDS')
# plt.plot(np.array(result_ra_loss), c='g', label='loss of DCFL+Random')
plt.plot(np.array(result_fl_loss), c='y', label='loss of FL')
plt.legend(loc='best')
plt.ylabel('loss_value')
plt.xlabel('training iteration')
plt.grid()
plt.savefig("FL_BDDS_ra_ea_loss.png")

plt.figure()
plt.plot(np.array(result_ea_acc), c='r', label='acc of DCFL+EA')
plt.plot(np.array(result_rl_acc), c='b', label='acc of DCFL+BDDS')
# plt.plot(np.array(result_ra_acc), c='g', label='acc of DCFL+Random')
plt.plot(np.array(result_fl_acc), c='y', label='acc of FL')
plt.legend(loc='best')
plt.ylabel('acc_value')
plt.xlabel('training iteration')
plt.grid()
plt.savefig("FL_BDDS_ra_ea_acc.png")
...
#
plt.figure()
plt.plot(np.array(central_res_loss), c='r', label='loss of centralization training')
plt.plot(np.array(result_rl_loss), c='b', label='loss of DCFL')
plt.legend(loc='best')
plt.ylabel('loss_value')
plt.xlabel('training iteration')
